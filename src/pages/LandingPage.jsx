                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="flex items-center space-x-4">
                            <Link to="/login" className="cursor-pointer hidden md:inline-block px-4 py-2 text-blue-600 font-medium hover:text-blue-700 transition-colors">
                                Entrar
                            </Link>
                            <Link to="/register" className="cursor-pointer px-6 py-2 bg-linear-to-r from-blue-600 to-purple-600 text-white font-medium rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all shadow-md hover:shadow-lg">
                                Começar Grátis
                            </Link>
